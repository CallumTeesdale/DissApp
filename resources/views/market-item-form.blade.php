...
<div class="form-wrap">
    <div class="form-container">
        <form class="login-form" method="POST" enctype="multipart/form-data"
            ...
            <input id="name" value="{{ $item->name ?? '' }}" placeholder="Item Name" type="text"
                class="form-control-text" name="name" required autocomplete="name">

            <br>
            <input id="description" value="{{ $item->description ?? '' }}" placeholder="Item description" type="text"
                class="form-control-text" name="description" required autocomplete="description">
            <input id="price" value="{{ $item->price ?? '' }}" placeholder="Item price" type="number"
                class="form-control-number" name="price" required autocomplete="price">
            ...
            <input id="barcode" value="{{ $item->barcode ?? '' }}" placeholder="Item barcode" type="text"
                class="form-control-text" name="barcode" required autocomplete="barcode">
            <br>
